...
export const getPreviousRoute = (state) => {
    if (state.routing && state.routing.locationBeforeTransitions && state.routing.locationBeforeTransitions.result) {
        return state.routing.locationBeforeTransitions.result.nextPathname;
    }
