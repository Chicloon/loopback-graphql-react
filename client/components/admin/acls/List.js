...
class ACLList extends React.PureComponent {
	...
	render () {
		return <List model={this.store.ACL}
			...
			<TextField property="model" items={aclsData.models} label={t('acl.model.title')}/>
			<TextField property='property' label={t('acl.property')}/>
			<TextField property="accessType" items={aclsData.accessTypes} label={t('acl.accessType')}/>
			<TextField property="permission" items={aclsData.permissions} label={t('acl.permission')}/>
			<TextField property="principalType" items={aclsData.principalTypes} label={t('acl.principalType')}/>
