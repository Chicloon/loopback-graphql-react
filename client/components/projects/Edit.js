...
import { PersonAvatar, Icon, ColorUtils, Comments } from '../ui';
import t from '../../../i18n';
	...
	render () {
		...
		return (
			<div className="fixed-width">
				<Form model={this.store.Project} returnTo={'projects'} {...this.props}>
				...
				{this.project && <Comments foreignKey='projectId' record={this.project}/>}
			</div>
		);
	}
}
